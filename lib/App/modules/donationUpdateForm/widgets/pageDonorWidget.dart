...
class PageDonorUpdateWidget extends StatelessWidget {
  DonationUpdateFormScreenController controller;
  PageDonorUpdateWidget({
                  ...
                  GetBuilder(
                    builder: (DonationUpdateFormScreenController controller) {
                      return CustomDropdownButton(
                        ...
                        data: controller.ages,
                        defaultValue: controller.donorAgeDefaultValue,
                      );
                    },
                  ),
                  SizedBox(
                  ...
                  GetBuilder(
                    builder: (DonationUpdateFormScreenController controller) {
                      return CustomDropdownButton(
                        ...
                        defaultValue: controller.donorBloodUnitDefaultValue,
                      );
                    },
                  ),
                ],
                  ...
                  GetBuilder(
                    builder: (DonationUpdateFormScreenController controller) {
                      return CustomDropdownButton(
                        ...
                        data: controller.weights,
                        defaultValue: controller.donorWeightDefaultValue,
                      );
                    },
                  ),
                  SizedBox(
                  ...
                  GetBuilder(
                    builder: (DonationUpdateFormScreenController controller) {
                      return CustomDropdownButton(
                        ...
                        defaultValue: controller.donorLocationDefaultValue,
                      );
                    },
                  ),
                ],
